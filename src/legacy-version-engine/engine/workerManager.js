...
export function getGradientWorker() {
    if (!gradientWorkerInstance) {
        gradientWorkerInstance = new WorkerManager('/legacy-workers/workers/gradientWorker.js', {
...
export function getStyleWorker() {
    if (!styleWorkerInstance) {
        styleWorkerInstance = new WorkerManager('/legacy-workers/workers/styleWorker.js', {
            poolSize: 2
        });
    }
